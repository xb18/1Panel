...
const message = {
    ...
    firewall: {
        ...
        legacy: 'Управляется старой версией',
        ...
        resolution_create_anyway: 'Всё равно создать',
        resolution_adopt: 'Взять под управление',
        resolution_select_adopt: 'Выбрать и взять под управление',
        ...
        scopeDefaultPolicy: 'Текущая политика по умолчанию: {0}',
        ...
        systemFirewall: 'Системный брандмауэр',
        forwardBackend: 'Перенаправление портов',
        dockerBackend: 'Брандмауэр Docker',
        firewallSettingHelper:
            'Системный брандмауэр, перенаправление портов и брандмауэр Docker выбираются независимо. Переносите правила вручную через экспорт и импорт.',
        systemFirewallHelper: 'Управляет доступом к портам хоста и входящими правилами.',
        forwardingHelper: 'Управляет перенаправлением портов и выбирается отдельно от системного брандмауэра.',
        dockerFirewallHelper: 'Управляет сетевыми правилами Docker. При переключении Docker перезапускается.',
        iptablesSuggestionTag: 'Приоритет совместимости',
        nftablesSuggestionTag: 'Для новых систем',
        iptablesSuggestion:
            'Рекомендуется для существующих правил iptables, нагрузок Docker и сред, где важна совместимость.',
        nftablesSuggestion:
            'Рекомендуется для новых систем Linux и новых установок. Перед переключением проверьте поддержку инструментов.',
        configuredRules: 'Настроено правил: {0}',
        addressFamily: 'Версия IP',
        portOrRange: 'Порт / диапазон',
        dockerNftGuardUnsupported: 'Нативный nftables Docker пока не поддерживает защиту портов контейнеров.',
        backendIndependentHelper: 'Выберите бэкенды системного брандмауэра, перенаправления и Docker независимо.',
        currentBackend: 'Текущий бэкенд',
        applyBackend: 'Применить выбор',
        cleanupManagedRules: 'Удалить правила 1Panel',
        exportAllRules: 'Экспортировать все правила',
        clearAllRules: 'Очистить все правила',
        importBackendHelper:
        ...
        cleanupManagedRulesHelper: 'Правила, созданные 1Panel, будут удалены из {0}. Продолжить?',
        switchBackendHelper: 'Переключиться на {0}? Существующие правила не будут перенесены или удалены.',
        ...
        filterHelper:
            'Правила фильтра позволяют управлять входящим сетевым трафиком на уровне INPUT. Настраивайте осторожно, чтобы избежать блокировки системы.',
        chain: 'Цепочка',
        targetChain: 'Целевая Цепочка',
        sourceIP: 'Исходный IP',
        destIP: 'Целевой IP',
        accessSource: 'Источник доступа',
        accessDestination: 'Назначение доступа',
        ...
        reorderTip: 'Перетащите, чтобы изменить порядок управляемых правил в этой группе',
        ufwReorderUnsupported:
            'Правила UFW показаны в фактическом порядке нумерации IPv4/IPv6. Ручное изменение порядка не поддерживается.',
        reorderBlocked:
            'Правила можно перемещать только внутри одной группы, не пересекая внешние, защищённые или нераспознанные правила.',
