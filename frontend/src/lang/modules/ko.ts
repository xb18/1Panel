...
const message = {
    ...
    firewall: {
        ...
        resolution_create_anyway: '그래도 생성',
        resolution_adopt: '관리 대상으로 전환',
        resolution_select_adopt: '선택하여 관리',
        adoptRuleConfirm:
        ...
        ruleCheckSummary: '규칙 {0}개 검사: 생성 가능 {1}개, 기존 {2}개, 경고 {3}개, 오류 {4}개.',
        ...
        ruleCheckPassedHelper: '검사를 통과했습니다. 규칙을 제출할 수 있습니다.',
        ...
        systemFirewall: '시스템 방화벽',
        forwardBackend: '포트 포워딩',
        dockerBackend: 'Docker 방화벽',
        ...
        addressFamily: 'IP 버전',
        portOrRange: '포트 / 범위',
        dockerNftGuardUnsupported: 'Docker 네이티브 nftables는 아직 컨테이너 포트 보호를 지원하지 않습니다.',
        backendIndependentHelper: '시스템, 포트 포워딩 및 Docker 방화벽 백엔드를 각각 선택합니다.',
        currentBackend: '현재 백엔드',
        applyBackend: '선택 적용',
        cleanupManagedRules: '1Panel 규칙 제거',
        ...
        cleanupManagedRulesHelper: '{0}에서 1Panel이 만든 규칙을 제거합니다. 계속하시겠습니까?',
        ...
        filterRule: '필터 규칙',
        filterHelper:
            '필터 규칙을 사용하면 INPUT 수준에서 인바운드 네트워크 트래픽을 제어할 수 있습니다. 시스템 잠금을 방지하기 위해 주의하여 구성하세요.',
        chain: '체인',
        targetChain: '대상 체인',
        sourceIP: '소스 IP',
        destIP: '대상 IP',
        accessSource: '접근 출발지',
        accessDestination: '접근 대상',
        direction: '방향',
        destPort: '대상 포트',
        action: '동작',
        priority: '우선순위',
        ...
        reorderTip: '드래그하여 이 그룹의 관리 규칙 순서를 변경합니다',
        ufwReorderUnsupported: 'UFW 규칙은 실제 IPv4/IPv6 번호 순서로 표시됩니다. 수동 순서 변경은 지원하지 않습니다.',
        reorderBlocked: '같은 그룹 안에서만 이동할 수 있으며 외부, 보호 또는 인식할 수 없는 규칙을 건널 수 없습니다.',
        quickJump: '빠른 이동',
        destination: '대상',
    },
    runtime: {
