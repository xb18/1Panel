...
const message = {
    ...
    firewall: {
        ...
        resolution_create_anyway: 'このまま作成',
        resolution_adopt: '管理対象にする',
        resolution_select_adopt: '選択して管理対象にする',
        ...
        scopeDefaultPolicy: '現在の既定ポリシー：{0}',
        ...
        systemFirewall: 'システムファイアウォール',
        forwardBackend: 'ポート転送',
        dockerBackend: 'Docker ファイアウォール',
        ...
        portOrRange: 'ポート / 範囲',
        dockerNftGuardUnsupported: 'Docker ネイティブ nftables は現在コンテナポート保護に対応していません。',
        backendIndependentHelper: 'システム、ポート転送、Docker の各ファイアウォールバックエンドを個別に選択します。',
        currentBackend: '現在のバックエンド',
        applyBackend: '選択を適用',
        cleanupManagedRules: '1Panel ルールを削除',
        ...
        cleanupManagedRulesHelper: '{0} から 1Panel が作成したルールを削除します。続行しますか？',
        ...
        filterRule: 'フィルタールール',
        filterHelper:
            'フィルタールールを使用すると、INPUT レベルで受信ネットワークトラフィックを制御できます。システムをロックしないように注意して設定してください。',
        chain: 'チェーン',
        targetChain: 'ターゲットチェーン',
        sourceIP: '送信元 IP',
        destIP: '宛先 IP',
        accessSource: 'アクセス元',
        accessDestination: 'アクセス先',
        direction: '方向',
        destPort: '宛先ポート',
        action: 'アクション',
        priority: '優先度',
        ...
        reorderTip: 'ドラッグしてこのグループの管理ルールを並べ替えます',
        ufwReorderUnsupported:
            'UFW ルールは IPv4/IPv6 の実際の番号順で表示されます。手動での並べ替えには対応していません。',
        reorderBlocked: '同じグループ内でのみ移動でき、外部・保護・認識できないルールを越えることはできません。',
        destination: '宛先',
    },
    runtime: {
        runtime: 'ランタイム',
