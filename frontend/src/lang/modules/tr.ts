...
const message = {
    ...
    firewall: {
        ...
        resolution_create_anyway: 'Yine de oluştur',
        resolution_adopt: 'Yönetimi devral',
        resolution_select_adopt: 'Seç ve yönetimi devral',
        ...
        ruleCheckSummary: '{0} kural kontrol edildi: {1} oluşturulabilir, {2} mevcut, {3} uyarı ve {4} hata.',
        ...
        ruleCheckPassedHelper: 'Kontrol başarılı. Kuralları gönderebilirsiniz.',
        ...
        scopeDefaultPolicy: 'Geçerli varsayılan ilke: {0}',
        ...
        filterHelper:
            'Filtre kuralları, INPUT seviyesinde gelen ağ trafiğini kontrol etmenize izin verir. Sistemi kilitlememek için dikkatli yapılandırın.',
        chain: 'Zincir',
        targetChain: 'Hedef Zincir',
        sourceIP: 'Kaynak IP',
        destIP: 'Hedef IP',
        accessSource: 'Erişim Kaynağı',
        accessDestination: 'Erişim Hedefi',
        direction: 'Yön',
        destPort: 'Hedef Port',
        action: 'Eylem',
        priority: 'Öncelik',
        ...
        reorderTip: 'Bu gruptaki yönetilen kuralları yeniden sıralamak için sürükleyin',
        ufwReorderUnsupported:
            'UFW kuralları gerçek IPv4/IPv6 numara sırasıyla gösterilir. Elle yeniden sıralama desteklenmez.',
        reorderBlocked:
            'Kurallar yalnızca aynı grup içinde taşınabilir; harici, korumalı veya tanınmayan kuralların üzerinden geçilemez.',
        destination: 'Hedef',
    },
    runtime: {
        runtime: 'Çalışma Zamanı',
