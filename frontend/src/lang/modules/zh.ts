...
const message = {
    ...
    firewall: {
        ...
        unUsed: '未使用',
        managed: '面板创建',
        managedHelper: '由 1Panel 创建并维护，可以编辑或删除。',
        adopted: '外部纳管',
        adoptedHelper: '原本是系统已有规则，目前已交由 1Panel 维护。',
        legacy: '旧版托管',
        external: '外部规则',
        drifted: '已漂移',
        protected: '系统保护',
        protectedHelper: '系统关键规则，为避免影响访问，不允许编辑或删除。',
        stateShort: { managed: '面板', adopted: '已纳管', external: '未纳管', protected: '受保护', drifted: '已漂移' },
        ...
        plan_managed_rule_drifted: '相同的托管规则与系统实际状态不一致，请先处理漂移。',
