...
const message = {
    ...
    firewall: {
        ...
        resolution_create: '创建规则',
        resolution_create_anyway: '仍然创建',
        resolution_adopt: '纳管',
        resolution_select_adopt: '选择并纳入管理',
        ...
        forwardBackend: '端口转发',
        dockerBackend: 'Docker 防火墙',
        firewallSettingHelper: '系统防火墙、端口转发和 Docker 防火墙可分别选择；规则迁移需通过导出和导入手动完成。',
        systemFirewallHelper: '用于管理主机端口访问和入站规则。',
        forwardingHelper: '用于处理端口转发规则，可与系统防火墙分别选择。',
        dockerFirewallHelper: '用于管理 Docker 网络规则，切换时会重启 Docker。',
        iptablesSuggestionTag: '兼容性优先',
        nftablesSuggestionTag: '新环境建议',
        iptablesSuggestion: '适合已有 iptables 规则、Docker 工作负载或优先考虑兼容性的环境。',
        nftablesSuggestion: '适合较新的 Linux 系统和新部署环境；切换前请确认现有工具支持 nftables。',
        configuredRules: '已配置 {0} 条规则',
        addressFamily: 'IP 版本',
        portOrRange: '端口 / 范围',
        dockerNftGuardUnsupported: 'Docker 原生 nftables 暂不支持容器端口防护。',
        backendIndependentHelper: '系统防火墙、端口转发和 Docker 防火墙分别选择后端，互不跟随。',
        currentBackend: '当前后端',
        applyBackend: '应用选择',
        cleanupManagedRules: '清理 1Panel 规则',
        ...
        cleanupManagedRulesHelper: '即将清理 {0} 中由 1Panel 创建的规则，是否继续？',
        switchBackendHelper: '即将切换为 {0}，现有规则不会迁移或清理，是否继续？',
        ...
        filterHelper: 'Filter 规则允许您在 INPUT 级别控制入站网络流量。请谨慎配置，避免锁定系统。',
        chain: '链',
        targetChain: '目标链',
        sourceIP: '源 IP',
        destIP: '目标 IP',
        accessSource: '访问来源',
        accessDestination: '访问目的',
        direction: '方向',
        destPort: '目标端口',
        action: '动作',
        priority: '优先级',
        ...
        reorderTip: '拖动以调整本组托管规则顺序',
        ufwReorderUnsupported: 'UFW 规则按 IPv4/IPv6 的实际编号展示，暂不支持手动调整顺序。',
        reorderBlocked: '只能在同一组内移动，并且不能跨越外部、受保护或无法识别的规则。',
    },
    runtime: {
        runtime: '运行环境',
        default: '默认',
