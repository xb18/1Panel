...
const message = {
    ...
    firewall: {
        ...
        managedHelper: 'Created and maintained by 1Panel. It can be edited or deleted.',
        adopted: 'Externally managed',
        adoptedHelper: 'An existing system rule that is now maintained by 1Panel.',
        ...
        plan_managed_rule_drifted: 'The matching managed rule differs from the live firewall. Resolve the drift first.',
